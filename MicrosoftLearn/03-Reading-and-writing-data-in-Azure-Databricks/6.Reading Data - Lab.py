...
# MAGIC %fs head dbfs:/mnt/training/wikipedia/clickstream/2015_02_clickstream.tsv
...
testDF = spark.read.option("sep", "\t").option("header", "true").schema(tsvSchema).csv(fileName)
#mozna tez spark.read.csv(fileName)      
