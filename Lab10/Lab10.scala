...
val sqlZorderQuery = timeIt(spark.sql("select * from Retail where StockCode = '22301'").collect())

// COMMAND ----------

// MAGIC %sql
// MAGIC select * from Retail where StockCode = '22301'
